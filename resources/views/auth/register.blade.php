                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="date" class="form-control @error('dob') is-invalid @enderror" placeholder="Enter dob" name="dob" value="{{ old('dob') }}" required autocomplete="dob">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="file" class="form-control @error('image') is-invalid @enderror" placeholder="Enter image" name="image"  accept="image/*" required autocomplete="off">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea placeholder="Enter address" name="address" id="address" class="form-control" cols="30" rows="5">{{ old('address') }}</textarea>
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
